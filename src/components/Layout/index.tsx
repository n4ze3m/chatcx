              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 justify-between">
                  <Link className="flex" href="/dashboard">
                    <div className="flex flex-shrink-0 items-center justify-center">
                      ...
                      <img
                        ...
                        alt="ChatCX"
                      />
                      <h3 className="ml-2 font-bold">ChatCX</h3>
                    </div>
                  </Link>
                  ...
                  <div className="-mr-2 flex items-center sm:hidden">
                    {/* Mobile menu button */}
                    <Disclosure.Button className="inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2">
